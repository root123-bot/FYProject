...
urlpatterns = [
    path("mybooking/", mybooking, name="mybookings"),
    ...
    path(
        "waitingverification/",
        TemplateView.as_view(template_name="waitingverification.html"),
    ...
    path(
        ...
        complete_hospital_profile,
        name="completeprofilehospital",
    ),
